...
public class PerformanceReportPage extends JFrame{
    ...
    public PerformanceReportPage(User user)
    {
        this.user = user;
        students = Student.loadData("src/main/data/student_information_test.txt");
    ...
    private void exportToPdf(List <Student> studentInfoList){
        ...
        try {
            ...
            DocumentService performanceReport = new DocumentService(pdfFile, true);
    ...
    private JPanel createElementForFilter(Font labelFont, JButton exportButton){
        ...
        //button events
        List<Student> studentInfoList = Student.loadData(ResourceManager.getStudentDataPath());
        exportButton.addActionListener(e -> exportToPdf(studentInfoList));
